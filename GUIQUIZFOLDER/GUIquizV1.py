...
questions_answers = {
    1: ["What is the purpose of a budget?", "To track your spending", "To limit your spending", "To plan for future expenses", 3],
    2: ["How does compound interest work?", "Interest on the initial amount only", "Interest on the initial amount plus previously earned interest", "Interest on the latest deposit only", 2],
    3: ["What is the difference between a debit card and a credit card?", "Both are types of credit cards", "Debit card deducts money directly from your account, while credit card allows borrowing with interest", "Debit card is for online purchases, and credit card is for in-person purchases", 1],
    4: ["Why is it important to have an emergency fund?", "To earn more interest", "To cover regular monthly expenses", "To be prepared for unexpected expenses", 2],
    5: ["What is the concept of 'pay yourself first'?", "Save a portion of your income before spending", "Pay off debts first before saving", "Spend all your income and save whatever is left", 1],
    6: ["What is the role of a credit score?", "Determines how much you can borrow", "Measures your ability to save money", "Reflects the number of purchases you've made", 1],
    7: ["How does inflation affect purchasing power?", "Increases it", "Decreases it", "Has no effect on it", 2],
    8: ["What is the difference between a stock and a bond?", "Stock represents ownership in a company, while a bond is a loan to a company or government", "Stock and bond are terms used interchangeably", "Stock and bond both represent ownership in a company", 1],
    9: ["Why is diversification important in investing?", "Reduces risk by spreading investments across different assets", "Concentrates investments in a single asset for higher returns", "Diversification is not important in investing", 1],
    10: ["What is the difference between simple and compound interest?", "Simple interest is earned on the initial amount only, while compound interest is earned on both the initial amount and previously earned interest", "Simple interest is earned at a higher rate than compound interest", "Simple interest is not a real financial concept", 1],
}
